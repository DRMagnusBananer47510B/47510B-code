...
void turn_example() {
  ...
  chassis.pid_drive_set(-2_in, 127);
  chassis.pid_wait();
  chassis.pid_drive_set(2.5_in, 127);
  chassis.pid_wait();
  pros::c::delay(1100);
  chassis.pid_wait();
  chassis.pid_turn_relative_set(2, 127);
  chassis.pid_wait();
  ...
  // //chassis.pid_drive_set(2_in,127);
  // chassis.pid_drive_set(10_in, 127);
  // chassis.pid_turn_relative_set(190_deg, 100);
  // pros::delay(300);
  // chassis.pid_turn_relative_set(180_deg, 100);
  // descoreRun();
  // pros::delay(1000);
...
void drive_and_turn() {
  ...
  chassis.pid_wait();
  chassis.pid_drive_set(1_in, 127);
  chassis.pid_turn_set(278_deg, TURN_SPEED);
  chassis.pid_wait();
  pros::delay(1350);
  chassis.pid_drive_set(-29_in, DRIVE_SPEED);
  chassis.pid_wait();
